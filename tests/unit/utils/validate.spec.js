...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/gangster-bluelight/nginx-gangster-web.git')).toBe(true)
    expect(validURL('https://github.com/gangster-bluelight/nginx-gangster-web.git')).toBe(true)
    expect(validURL('https://github.com/gangster-bluelight/nginx-gangster-web.git')).toBe(false)
  })
  it('validLowerCase', () => {
